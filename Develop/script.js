...
function generatePassword(){
        ...
        var length = prompt('Password length can be between 8-128 chracters, how many characters would you like it to be?');
          ...
          // At least one character type must be selected, otherwise stops function
          if(shouldIncludeUpper!= true && shouldIncludeLower !=true && shouldIncludeNumbers !=true && shouldIncludeSpecial !=true){
            alert("Atleast one selector type must be used");
            return;
          }
         ...
         var randomizedPassword = []
          ...
          // joins the array and eliminates the comma separating them
